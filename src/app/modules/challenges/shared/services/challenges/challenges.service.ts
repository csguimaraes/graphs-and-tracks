...
import { Challenge, CHALLENGE_TYPE } from 'challenges'
import { CHALLENGE_EXAMPLES, EDITOR_SETUP, TUTORIAL_CHALLENGE } from './built-in-challenges'
...
export class ChallengesService {
	...
	private loadBuiltinChallenges() {
		this.examples = CHALLENGE_EXAMPLES
		this.tutorial = TUTORIAL_CHALLENGE
		this.exploration = EDITOR_SETUP
